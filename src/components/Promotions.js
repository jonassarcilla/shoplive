    ...
    return (
        <section className='bg-accent'>
            <div className='flex flex-col container mx-auto pt-10 px-5'>
                ...
                <button className='flex-auto rounded-lg bg-black' aria-label="Google PlayStore">&nbsp;</button>
                <button className='flex-auto rounded-lg bg-black' aria-label="Apple Store">&nbsp;</button>
                </div>
